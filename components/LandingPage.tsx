...
const LandingPage = () => {
  ...
  // Loading screen timing - show for 1 second
  useEffect(() => {
  ...
  const zenVariants = {
    // Page entrance - starts after loading screen ends
    pageContainer: {
      initial: { opacity: 0 },
      animate: {
        opacity: showLoading ? 0 : 1,
        transition: { duration: 1.2, delay: showLoading ? 0 : 0.2 },
      },
    },

    // Navigation gentle slide down - starts after loading screen ends
    navigation: {
      initial: { y: -60, opacity: 0 },
      animate: {
        y: showLoading ? -60 : 0,
        opacity: showLoading ? 0 : 1,
        transition: { duration: 1, delay: showLoading ? 0 : 0.4 },
      },
    },

    // Hero content staggered reveal - starts after loading screen ends
    heroContent: {
      ...
      animate: {
        ...
        transition: {
          duration: 1.2,
          ease: "easeOut",
          delay: showLoading ? 0 : 0.2,
        },
      },
    },

    // Hero title character reveal - starts after loading screen ends
    heroTitle: {
      initial: { opacity: 0 },
      animate: {
        opacity: showLoading ? 0 : 1,
        transition: { duration: 0.8, delay: showLoading ? 0 : 0.6 },
      },
    },

    // Hero description - starts after loading screen ends
    heroDescription: {
      initial: { y: 30, opacity: 0 },
      animate: {
        y: showLoading ? 30 : 0,
        opacity: showLoading ? 0 : 1,
        transition: { duration: 1, delay: showLoading ? 0 : 0.8 },
      },
    },

    // Hero tagline - starts after loading screen ends
    heroTagline: {
      initial: { y: 30, opacity: 0 },
      animate: {
        y: showLoading ? 30 : 0,
        opacity: showLoading ? 0 : 1,
        transition: { duration: 1, delay: showLoading ? 0 : 1.0 },
      },
    },

    // CTA Button - starts after loading screen ends (last to show)
    ctaButton: {
      initial: { y: 30, opacity: 0 },
      animate: {
        y: showLoading ? 30 : 0,
        opacity: showLoading ? 0 : 1,
        transition: { duration: 1, delay: showLoading ? 0 : 1.6 },
      },
    },
      ...
      <motion.div
        ...
        animate={{
          ...
          transition: {
            duration: 1.8,
            delay: showLoading ? 0 : 0.2,
            ease: [0.25, 0.1, 0.25, 1.0], // Very slow ending
          },
        }}
      >
        {/* Fixed Navigation */}
          ...
          <div className="main-content mx-auto">
                ...
                >
                  ...
                  <motion.p
                    ...
                    animate={{
                      ...
                      transition: {
                        duration: 1.8,
                        delay: showLoading ? 0 : 0.8,
                        ease: [0.25, 0.1, 0.25, 1.0], // Very slow ending
                      },
                    }}
                  >
                    ensori is a minimalist to-do app designed to keep you
                    present.
                  </motion.p>
                  <motion.p
            ...
            >
              ...
              <motion.div
                ...
                initial={{ x: -50, opacity: 0 }}
                animate={
                  featuresInView ? { x: 0, opacity: 1 } : { x: -50, opacity: 0 }
                }
              ...
              >
                ...
                >
                  ...
                  flexible. it could mean "in progress," "partially done," or
                  "do it next." you define what it means to you.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  from the enso-like status icon to the clean, handwritten
                  caveat font. it's a to-do app that feels personal and calm.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  early morning or organizing your evening. Minimal and
